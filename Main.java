...
class Main {
  public static void main(String[] args) {
    ...
    Part3Method5 p3=new Part3Method5();
    p3.divisibleBy3While(2,10);
// //     Scanner scanner=new Scanner(System.in);
// //     System.out.println("Enter the number of times the program to be printed");
// // int num=Integer.valueOf(scanner.nextLine());
// // Part3Method1 p1=new Part3Method1();
...
// // i++;
// // }
//     Part3Method3 p2=new Part3Method3();
//    p2.printUntilRevrseNumber(4);
